 ...
 */
public class RequestParsingException extends RequestResponseException {
    public static final int ERROR_CODE = 2007;
    public static final String ERROR_MESSAGE = "Failed to parse request, please contact an Administrator.";
     ...
     * @since 1.7
     */
    public RequestParsingException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
