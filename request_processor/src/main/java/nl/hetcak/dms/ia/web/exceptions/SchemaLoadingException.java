 ...
 */
public class SchemaLoadingException extends RequestResponseException {
    public static final int ERROR_CODE = 2007;
    public static final String ERROR_MESSAGE = "Unable to load XSD Schemas, please contact an Administrator.";
     ...
     * @since 1.7
     */
    public SchemaLoadingException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
