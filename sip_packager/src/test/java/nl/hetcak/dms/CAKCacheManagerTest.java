 ...
 */
public class CAKCacheManagerTest {
    ...
    public void add() throws Exception {
        ...
        CAKMessageParser cmp = new CAKMessageParser(mobjConfigManager.getConfiguration().getMessageParser());
        IADocument iad = cmp.parse(objBuilder.toString()).get(0);

        IARetentionClass objRetentionClass = new CAKRetentionClass("Z01");


        CAKCacheManager ccm = new CAKCacheManager(mobjConfigManager.getConfiguration().getCacheConfiguration());
        ccm.initializeCache();
